...
const WireTransfer = () => {
  ...
  useEffect(() => {
    ...
    if (recipientName && bankAccountNumber && routingNumber && bankName && amount && remarks) {
      setAllFieldsFilled(true);
    } else {
      setAllFieldsFilled(false);
    }
  }, [recipientName, bankAccountNumber, routingNumber, bankName, amount, remarks]);
          ...
          <div className="relative w-full h-full max-w-md md:h-auto">
            <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
              ...
              <div className="p-6 text-center">
                ...
                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Dear Client, in conjunction with our new terms and conditions, you can not transfer money to the recipient since there has been no active transactions between you both. We will contact you for further explanation</h3>
