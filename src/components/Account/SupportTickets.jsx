...
const SupportTickets = () => {
  ...
  return (
    ...
    <div>
            <div className=" w-full flex justify-center w-150" style={{ height: '348px' }}>
                <div className="flex flex-col">
                    <div className="w-full md:relative bg-gray-100 md:rounded-bl-lg md:rounded-br-lg
            ...
            <div className="flex justify-center flex-col mt-5 mb-3.5">
                <h1 className="text-center font-bold text-3xl">{userData.displayName}</h1>
