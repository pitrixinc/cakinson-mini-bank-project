    ...
    <div>
      <div class="w-full max-w-lg min-w-md p-4 bg-white rounded-lg shadow sm:p-8 ">
        <div class="flex items-center justify-between mb-4">
          ...
          <p className="text-sm ml-2 font-medium text-white hover:underline dark:text-white cursor-pointer" onClick={handleShowMoreClick}>
             View more
          </p>
        </div>
...
<div class="mt-4">
<p className="text-sm font-medium text-white hover:underline dark:text-white cursor-pointer" onClick={handleShowMoreClick}>
View more
</p>
</div>
)}
